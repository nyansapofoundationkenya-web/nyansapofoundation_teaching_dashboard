...
export default function GetStarted({ organizationId }) {
  ...
  return (
    <section className="p-6 rounded-lg text-center">
      ...
      <p className="text-sm md:text-base mb-4 text-gray-600">
        Create a new learning project to organize your schools, instructors, camps, and
        students. Track progress and gain insights into learning outcomes with our AI-
        powered analytics.
      </p>
      <button
