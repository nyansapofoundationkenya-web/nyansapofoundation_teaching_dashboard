...
export default function MapAssessmentsPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-6 sm:p-8 text-center w-full max-w-sm">
          ...
          <h2 className="text-lg sm:text-xl font-bold text-red-400 mb-2">Access Denied</h2>
          <p className="text-gray-300 text-sm">Superadmin privileges required to manage assessment mappings.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <DashboardLayout title="Map Assessments" organizationId={organizationId} currentSection="map-assessments">
      {/* Outer wrapper: clamp width and prevent any horizontal overflow */}
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 overflow-x-hidden">

        {/* Toast — fixed, full-width on mobile with safe margins */}
        {toast && (
          <div className={`fixed top-3 left-3 right-3 sm:left-auto sm:right-6 sm:top-6 sm:w-auto z-50 px-4 py-3 rounded-xl shadow-2xl transition-all duration-300 ${
        ...
        {/* Stats — 2-col always on mobile, 4-col on md+ */}
        ...
        {/* Type Toggle — full width on mobile, auto on sm+ */}
        ...
        <div className="bg-background-light rounded-2xl p-3 sm:p-4 mb-4 sm:mb-6 flex flex-col gap-3">
          ...
          {/* Grade + Mapping + count — row, wraps if needed */}
        ...
        {filteredAssessments.length === 0 ? (
          <div className="bg-background-light rounded-2xl p-8 sm:p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-300 mb-2">No assessments found</h3>
  ...
  return (
    <div className="bg-background-light rounded-2xl border border-gray-700/50 overflow-hidden shadow-lg">
      ...
      <div className="p-3 sm:p-5">
        {/* Top row: status dot + title area + action buttons */}
        <div className="flex items-start gap-2 sm:gap-3">
          ...
          {/* Title + badges — takes remaining space, min-w-0 prevents overflow */}
          ...
          {/* Action buttons — always a column on very small, row on sm+ */}
        ...
        {/* Assigned org chips — wrapping flex (no horizontal scroll) */}
        {assignedCount > 0 && (
